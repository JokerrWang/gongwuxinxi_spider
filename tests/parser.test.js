...
test("parseNotices keeps recruitment notices and excludes public notices", () => {
  const html = `
    <ul>
      ...
      <li><a href="/sydw.html">天津市某单位2026年公开招聘工作人员拟聘用名单</a>[02-25]</li>
  ...
  assert.ok(notices.every((notice) => !notice.title.includes("公示")));
});
